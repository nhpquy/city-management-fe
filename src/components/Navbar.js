  ...
  const drawerContent = (
    <Box sx={{ width: 250, backgroundColor: '#3f51b5', height: '100%', color: 'white' }} role="presentation">
      <List>
        ...
        <ListItem button component={Link} to="/cities" selected={isActive('/cities')} onClick={handleDrawerToggle}>
          <ListItemText primary="City" sx={{ color: isActive('/cities') ? '#ff9800' : 'white' }} />
        </ListItem>
        <ListItem button component={Link} to="/electricity-list" selected={isActive('/electricity-list')} onClick={handleDrawerToggle}>
          <ListItemText primary="Electricity" sx={{ color: isActive('/electricity-list') ? '#ff9800' : 'white' }} />
        </ListItem>
        <ListItem button component={Link} to="/water-supply-list" selected={isActive('/water-supply-list')} onClick={handleDrawerToggle}>
          <ListItemText primary="Water Supply" sx={{ color: isActive('/water-supply-list') ? '#ff9800' : 'white' }} />
        </ListItem>
        ...
        <Toolbar>
          ...
          {isMobile ? (
            ...
            <Box sx={{ display: 'flex', gap: '1rem' }}>
              ...
              <Button
                color={isActive('/cities') ? 'primary' : 'inherit'}
                component={Link}
                to="/cities"
                sx={{
                  fontSize: '1rem',
                  fontWeight: 500,
                  color: isActive('/cities') ? '#ff9800' : 'inherit',
                }}
              >
                City
              </Button>
              <Button
                color={isActive('/electricity-list') ? 'primary' : 'inherit'}
                component={Link}
                to="/electricity-list"
                sx={{
                  fontSize: '1rem',
                  fontWeight: 500,
                  color: isActive('/electricity-list') ? '#ff9800' : 'inherit',
                }}
              >
                Electricity
              </Button>
              <Button
                color={isActive('/water-supply-list') ? 'primary' : 'inherit'}
                component={Link}
                to="/water-supply-list"
                sx={{
                  fontSize: '1rem',
                  fontWeight: 500,
                  color: isActive('/water-supply-list') ? '#ff9800' : 'inherit',
                }}
              >
                Water Supply
              </Button>
